...
export default async ({ client, directory }) => {
  ...
  const getBootstrapContent = () => {
    ...
    const skillPath = path.join(pilotResearchSkillsDir, 'using-pilot-research', 'SKILL.md');
...
${toolMapping}
  ...
  return {
    config: async (config) => {
      ...
      if (!config.skills.paths.includes(pilotResearchSkillsDir)) {
        config.skills.paths.push(pilotResearchSkillsDir);
      }
    },
